...
#2) apro il file dove scrivere
with open('politcs_raw.csv',mode='w')  as file:
    ...
    #3) scandaglio ogni pagina di ogni link e mi salvo nome prezzo e superficie
    y=0
    ...
    while y < len_cities:
        ...
        for x in range(2005,2015):
            ...
            #print(prova.get_dom_attribute("class"))
            if num_party == 1:
                party=partito
            else:
                party='more_party'
            ...
            #prendo valori che mi interessano
            try:
                ...
                pass
                #5) savo su arrey i valori precedenti e poi scrivo la riga sul file csv
