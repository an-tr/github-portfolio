...
with open('politics_raw.csv',mode='w')  as file:
    ...
    writer.writerow(['city','year','party','tot_invest','administration_invest','social_invest','environment_invest','transport_invest','education_invest','culture_invest','sport_invest','tourism_invest','economic_invest','sevice_invest','police_invest','justice_invest'])
    ...
    while y < len_cities:
        ...
        for x in range(2005,2015):
            ...
            try:
                ...
                administration_invest=driver.find_element(By.XPATH, "//*[@id='heading-consuntivo-spese-cassa-spese-somma-funzioni-amministrazione']/div[1]/div[4]/div[2]/p/strong/span").text
            ...
            array.append(administration_invest.replace('€',''))
