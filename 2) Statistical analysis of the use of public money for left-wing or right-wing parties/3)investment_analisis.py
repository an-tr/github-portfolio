...
mean_administration_invest_right = df_right['administration_invest'].mean()
...
mean_administration_invest_left = df_left['administration_invest'].mean()
...
####### administration_invest

category='administration_invest'
...
plt.title('administration year by year trend')
plt.legend()
...
category_diff=[]
categories=['administration_invest','social_invest','environment_invest','transport_invest','education_invest','culture_invest','sport_invest','tourism_invest','economic_invest','police_invest','justice_invest']
...
fig, ax = plt.subplots()
bar1 = ax.bar( 1,mean_administration_invest_left,0.1,  label='administration left')
bar2 = ax.bar( 1+0.1,mean_administration_invest_right,0.1, label='administration right')
